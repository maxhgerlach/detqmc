...
namespace boost { namespace program_options {
    ...
    */
    ...
    public:
        ...
        virtual void set_option_name(const std::string& /*option_name*/){} //Patched by Max Gerlach to remove warning according to https://svn.boost.org/trac/boost/ticket/7803
