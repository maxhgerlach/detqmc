...
//      ("timedisplaced", po::value<bool>(&modelpar.timedisplaced)->default_value(false), "also evaluated imaginary time-displaced Green functions and related observables")
        ...
        ("r", po::value<num>(&modelpar.r), "SDW model: parameter tuning SDW transition")
        ("lambda", po::value<num>(&modelpar.lambda)->default_value(1.0), "SDW model: fermion-boson coupling")
        ...
        ("wolffClusterShiftUpdate", po::value<bool>(&modelpar.wolffClusterShiftUpdate)->default_value(false), "SDW: perform global Wolff-like single cluster update combined with the global shift move")
